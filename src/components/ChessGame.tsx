...
export default function ChessGame() {
  ...
  // Use the AnyChessboard hack to bypass TS errors if they persist
            ...
            <div className="flex items-center justify-around py-8 border-b border-zinc-800 bg-[#2c2c2c]/30">
              <div className="flex flex-col items-center gap-3">
                ...
                <input
                  ...
                  className="bg-transparent border-none border-b border-[#4a4a4a] text-white text-[12px] text-center w-[100px] outline-none font-bold uppercase tracking-widest focus:border-[#81b64c] transition-colors disabled:opacity-50"
